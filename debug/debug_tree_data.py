...
def debug_tree_data():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"✅ API节点数: {len(api_data.get('nodes', {}))}")
            print(f"✅ API根节点: {api_data.get('root_node', 'N/A')}")
        ...
        try:
            with open('config/decision_tree.yaml', 'r', encoding='utf-8') as f:
                ...
                print(f"✅ 文件节点数: {len(tree_data.get('nodes', {}))}")
                print(f"✅ 文件根节点: {tree_data.get('root_node', 'N/A')}")
